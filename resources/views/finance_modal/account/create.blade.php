                    ...
                    <div class="card o-hidden border-0 shadow-lg my-5">
                        <div class="card-body p-2">
                            <div class="row justify-content-center">
                                <div class="col-lg-6">
                                    <div class="p-5">
                                        <form class="account" method="post" action="/account/store">
                                            @csrf
                                            <div class="form-group">
                                                <label for="account_name">Account Name</label>
                                                <input type="text" class="form-control form-control-user @error('account_name') is-invalid @enderror" id="account_name" value="{{ old('account_name') }}" name="account_name">
                                                @error('account_name')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-use @error('account_type') is-invalid @enderror" id="account_type" value="{{ old('account_type') }}" name="account_type">
                                                @error('account_type')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
